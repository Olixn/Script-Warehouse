...
// @grant        GM_getValue
// @license      MIT
// @supportURL   http://script.521daigua.cn/faq.html
// @homepage     http://script.521daigua.cn
// ==/UserScript==
...
var setting = {
    ...
    apihost = "https://api.gocos.cn/index.php/cxapi";
...
if (!$) {
    ...
    */
    _self.Element.prototype._addEventListener = Element.prototype.addEventListener;
    _self.Element.prototype.addEventListener = function () {
     ...
     * https://bbs.tampermonkey.net.cn/
    */
    _self.Element.prototype.attachShadow = undefined;
...
function beforeFind() {
    setting.div = $(
        '<div style="border: 2px dashed rgb(0, 85, 68); width: 330px; position: fixed; top: 0; left: 0; z-index: 99999; background-color: rgba(184, 247, 255, 0.3); overflow-x: auto;">' +
